...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        this.http.get("https://api.imgur.com/3/account/miwtoo/images", httpOptions).subscribe(function (getData) {
            console.log("GET Request is successful ", getData);
            _this.images = getData["data"];
    ...
    AppComponent.prototype.onSubmit = function (data) {
        ...
        this.http.post("https://api.imgur.com/3/image", this.img, httpOptions).subscribe(function (getData) {
            console.log("GET Request is successful ", getData);
            _this.imgData = getData['data'];
        }, function (error) {
            console.log("Error", error);
        });
        this.http.get("https://api.imgur.com/3/account/miwtoo/images", httpOptions).subscribe(function (getData) {
...
module.exports = __webpack_require__(/*! D:\User profile\Documents\GitHub\UploadPicture-TestAPI\client\src\main.ts */"./src/main.ts");
